...
match priority:
    ...
    case "medium":
        if time_bound == "yes":
            ...
            print(f"Note: '{task}' is a medium priority task. Schedule it for completion.")
    case "low":
        if time_bound == "yes":
            print(f"Note: '{task}' is a low priority task but has a deadline. Try to complete it on time.")
        else:
